...
/**
 * Call Gemini API directly from the client/browser using the user's provided API key.
 */
export async function callGeminiDirectly(stats: ComputedStats, apiKey: string): Promise<string> {
