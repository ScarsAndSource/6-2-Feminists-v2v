...
const stages: { id: JourneyStage; label: string }[] = [
  { id: 'landing', label: 'Landing' }, { id: 'log', label: 'Log Symptoms' }, { id: 'report', label: 'Your Report' }, { id: 'suggestions', label: 'AI Suggestions' }, { id: 'helper', label: 'Ask the Helper' }, { id: 'patterns', label: 'Your Patterns' }, { id: 'doctor', label: 'When to See a Doctor' }
];
